...
abstract class _ParticipantWidgetState<T extends ParticipantWidget>
  ...
  Widget build(BuildContext ctx) => Container(
        ...
        child: Stack(
          children: [
            // Video / Placeholder when local screen sharing to avoid mirror recursion
            if (widget.participant is LocalParticipant &&
                widget.useScreenShareTrack &&
                widget.screenShareTrack != null &&
                widget.screenShareTrack!.muted == false)
              Align(
            ...
            else if (activeVideoTrack != null && !activeVideoTrack!.muted)
              (widget.isZoom
                  ? GestureZoomBox(
                      maxScale: 5.0,
                      doubleTapScale: 2.0,
