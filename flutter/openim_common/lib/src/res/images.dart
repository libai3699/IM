...
class ImageRes {
  ...
  // New dedicated screen share icons for voice call page
  static const screenShareActive = "$_dir/screen_share_active.webp";
  static const screenShareDead = "$_dir/screen_share_dead.webp";
