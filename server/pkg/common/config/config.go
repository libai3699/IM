...
type configStruct struct {
	...
	Msg struct {
		MsgGatewayPort        []int `yaml:"msgGatewayPort"`
		MaxMsgLimit           int   `yaml:"maxMsgLimit"`
		MaxSearchLimit        int   `yaml:"maxSearchLimit"`
		MsgChannelTimeout     int   `yaml:"msgChannelTimeout"`
		HandshakeTimeout      int   `yaml:"handshakeTimeout"`
		ListenIP              string `yaml:"listenIP"`
		DefaultReadTimeout    int   `yaml:"defaultReadTimeout"`
		DefaultWriteTimeout   int   `yaml:"defaultWriteTimeout"`
