...
type Attribute struct {
	...
	GoogleAuthSecret  string    `gorm:"column:google_auth_secret;type:varchar(64)"`  // 谷歌验证码密钥
	GoogleAuthEnabled bool      `gorm:"column:google_auth_enabled;default:false"`    // 是否启用谷歌验证码
}
...
type AttributeInterface interface {
	...
	SearchNormalUser(ctx context.Context, keyword string, forbiddenID []string, gender int32, page int32, size int32, fuzzy bool) (uint32, []*Attribute, error)
