...
var (
	...
	getGroupMemberUserIDs    = NewApiCaller[group.GetGroupMemberUserIDsReq, group.GetGroupMemberUserIDsResp]("/group/get_group_member_user_id", imApi)
	getFriendIDs             = NewApiCaller[friend.GetFriendIDsReq, friend.GetFriendIDsResp]("/friend/get_friend_id", imApi)
	sendBusinessNotification = NewApiCaller[SendBusinessNotificationReq, SendBusinessNotificationResp]("/msg/send_business_notification", imApi)
	sendMsg                  = NewApiCaller[SendMsgReq, SendMsgResp]("/msg/send_msg", imApi)
)
